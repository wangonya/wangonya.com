...
[[https://docs.celeryq.dev/en/stable/getting-started/first-steps-with-celery.html#first-steps][start here]].
...
[[https://docs.celeryq.dev/en/stable/reference/celery.result.html#celery.result.AsyncResult][AsyncResult]]
...
** Signals
   ...
   :END:
There are
[[https://docs.celeryq.dev/en/stable/userguide/signals.html#signals][a lot]] of signals that celery offers but I'll focus on 4 simple ones to
