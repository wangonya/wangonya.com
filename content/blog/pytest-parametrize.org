...
[[https://stackoverflow.com/a/129722/9312256][This]] SO answer sums it
up nicely:
...
Let's take a simple test case: checking that the endpoints return =200=
when called.
...
Here's how the tests can be rewritten using
[[https://docs.pytest.org/en/stable/parametrize.html#parametrize-basics][Pytest
parametrize]]:
...
=report_sheet_endpoints= and feeds it into the test. This reduces
duplication while maintaining readability.
